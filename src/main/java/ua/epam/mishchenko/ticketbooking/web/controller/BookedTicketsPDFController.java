...
public class BookedTicketsPDFController {
    ...
    public ResponseEntity<Object> getBookedTicketsByUserPDF(@PathVariable String userId,
        ...
        List<TicketResponse> bookedTickets = getBookedTickets(userId, pageSize, pageNum, userById);
     ...
     */
    private List<TicketResponse> getBookedTickets(String userId, int pageSize, int pageNum, User userById) {
     ...
     */
    private ResponseEntity<Object> createResponseEntityWithPDFDocument(List<TicketResponse> bookedTickets) {
     ...
     * @param bookedTickets the booked tickets
     */
    private void createPDFDocument(List<TicketResponse> bookedTickets) {
